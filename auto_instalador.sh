...
mostrar_ajuda() {
  ...
  echo -e "  ${VERDE}-a, --avancado${NC}          Ativa configurações avançadas de estabilidade e segurança"
  echo ""
  ...
  echo ""
  echo -e "${BRANCO}No modo avançado também serão solicitados:${NC}"
  ...
  echo -e "  ${VERDE}sudo ./auto_instalador.sh --avancado${NC}"
  echo ""
  exit 0
}
...
# Se modo avançado estiver ativado, mostrar banner
